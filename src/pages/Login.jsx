...
const Login = () => {
    ...
    const handleLogin = async (event) =>{
        ...
        const res = await auth.signInWithEmailAndPassword( userInfo.email , userInfo.password);
        console.log(res);
    ...
    //                 <input type="text" classNameName="block w-full px-4 py-1 mt-1 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring" onChange={event => setUserInfo({...userInfo , email: event.target.value})}/>
    //             </div>
    ...
    //                 <input type="password" classNameName="block w-full px-4 py-1 mt-1 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring" onChange={event => setUserInfo({...userInfo , password: event.target.value})}/>
    //             </div>

    //             <div classNameName="mt-4">
    //                 <button classNameName="w-full px-4 py-1 tracking-wide text-white transition-colors duration-200 transform bg-gray-700 rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600" onClick={handleLogin}>
    //                     Login
    //                 </button>
    //             </div>
    //         </form>
    ...
    //             <Link to={'sign-up'}>
    //                 <a href="#" classNameName="font-medium text-gray-800 dark:text-gray-200 hover:underline">Create One</a>
    //             </Link>
    //         </p>
    //     </div>
    // </div>
                ...
                <form action="#" autoComplete="off">
                    <div className="flex flex-col mb-2">
                        ...
                        <div className="flex w-full">
                            <button type="submit" className="py-2 px-4  bg-purple-600 hover:bg-purple-700 focus:ring-purple-500 focus:ring-offset-purple-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg " onClick={handleLogin}>
                                Login
                            </button>
                        </div>
                    </form>
