    ...
    return(
        <div className={"h-screen flex justify-center items-center"}>
            <div className="flex flex-col w-full max-w-md px-4 py-8 bg-white rounded-lg shadow-2xl dark:bg-gray-800 sm:px-6 md:px-8 lg:px-10">
                ...
                <div className="flex items-center justify-between xs: mt-4">
                    ...
                    <Link to={'/log-in'} className="inline-flex items-center text-xs font-thin text-center text-gray-500 hover:text-gray-700 dark:text-gray-100 dark:hover:text-white">
                        <span className="ml-2">
