...
const Navbar = () => {
    ...
    return ( 
        // <nav classNameName="px-6 py-3 shadow bg-white">
        //     <div classNameName="items-center justify-between md:flex">
        //         <div classNameName="flex items-center justify-between">
        //             <Link to={"/"}>
        //                 <div>
        //                     <p classNameName="text-xl font-bold text-gray-800 dark:text-white md:text-2xl hover:text-gray-700 dark:hover:text-gray-300">Forms Now</p>
        //                 </div>
        //             </Link>

        //             {/* <!-- Mobile menu button --> */}
        //             <div classNameName="md:hidden">
        //                 <button type="button" classNameName="text-gray-500 dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-400 focus:outline-none focus:text-gray-600 dark:focus:text-gray-400" aria-label="Toggle menu">
        ...
        //         <div classNameName="flex flex-col mt-2 -mx-2 md:mt-0 md:flex-row md:block">
        //             <a href="#" classNameName="px-2 py-2 text-sm text-gray-800 rounded-md dark:text-gray-200 hover:bg-gray-900 hover:text-gray-100 hover:font-medium md:mx-2">Home</a>
        //             <a href="#" classNameName="px-2 py-2 text-sm text-gray-800 rounded-md dark:text-gray-200 hover:bg-gray-900 hover:text-gray-100 hover:font-medium md:mx-2">About</a>
        //             {/* <a href="#" classNameName="px-2 py-2 text-sm text-gray-800 rounded-md dark:text-gray-200 hover:bg-gray-900 hover:text-gray-100 hover:font-medium md:mx-2">Contact</a> */}
        //             {
        //                 loggedInUser
        //             }
        //         </div>
    ...
    <div className="inline-flex">
        ...
        <p className={"text-2xl font-semibold text-gray-800"}>Forms now</p>
    </div>
{/* 
    <!-- end logo -->
    ...
    <div className="flex-initial">
      <div className="flex justify-end items-center relative">
        ...
        :
        (<Link to={'/log-in'}><a href="#" classNameName="px-2 py-2 text-sm font-semibold text-white rounded-md bg-purple-500 dark:text-gray-200 hover:bg-purple-700 hover:font-medium md:mx-2">Log in</a></Link>)
        }
      </div>
    </div>
    {/* <!-- end login --> */}
